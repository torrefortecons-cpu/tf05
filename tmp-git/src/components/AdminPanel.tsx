...
export default function AdminPanel({
  ...
  return (
    <div className="max-w-[1820px] mx-auto px-2 md:px-8 py-4 md:py-8 animate-fade-in text-sm relative">
      ...
      <div className="lg:hidden flex flex-col gap-2 bg-transparent mb-1 select-none touch-pan-x">
        {/* Horizontal scroll ribbon prioritizing icons with circular chips and badges */}
        <div className="flex flex-nowrap gap-3 overflow-x-auto pb-2 pt-1 px-1 snap-x touch-pan-x">
          
          {/* Metric Selector */}
          <button 
            onClick={() => setActiveTab('metrics')}
            className="flex flex-col items-center gap-1 shrink-0 snap-start active:scale-95 transition-transform focus:outline-none"
          >
            ...
            <span className={`text-[9px] tracking-wide font-bold uppercase text-center w-12 truncate ${
